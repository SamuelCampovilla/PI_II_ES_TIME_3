    ...
    for (const course of courses || []) {
        ...
        <div class="course" data-course-id="${course.id_curso}"> 
            <div class="course-header">
                <span class="nome_curso"><img src="/frontend/src/assets/images/book.png" alt=""> ${course.nome_curso}</span>
                <div class="btn-group">
                    <button class="btn btn-primary btnNovaDisciplina" data-course-id="${course.id_curso}">+ Nova Disciplina</button>
                    <button class="btn-icon btnEditarCurso" title="Editar Curso"><img src="/frontend/src/assets/images/pencil.png" alt=""></button>
                    <button class="btn-icon btnExcluirCurso" title="Excluir Curso"><img src="/frontend/src/assets/images/trash.png" alt=""></button>
                </div>
            </div>
